...
console.log("\x1b[36m" + "O saldo total é: " + calcularSaldoFinal(conta.saldo, conta.extrato[0].valor) + "\x1b[0m");
// Exercício 6
function calcularPrecoComTaxa(preco,taxa){
    return preco + taxa
}
console.log("\x1b[33m" + "Preço com Taxa: " + calcularPrecoComTaxa(pedido.total, 6.00 ) + "\x1b[0m");
// Exercício 7
...
console.log("\x1b[35m" + "O dobro do valor é: " + dobrarValor(4.00) + "\x1b[0m");
// Exercício 8
 function calcularTroco(valorPago,valorTotal) {
    return valorPago - valorTotal
 }
 console.log("\x1b[32m" + "O Troco é: " + calcularTroco(100,pedido.total)+ "\x1b[0m");
 // Exercício 8
